...
urlpatterns = [
    ...
    # url('api-auth/', include('rest_framework.urls', namespace='rest_framework'))
     ...
     # url(r'incidentapi/$', views.charcoalReportsView, name='map'),

     url(r'charcoalalert/$', views.charcoalalertView, name='alertviewapi'),        

	url(r'^extenta/$', views.ExtentView, name='extenta'),

     url(r'charcoalreportspoint/$', views.charcoalReportspointView, name='charcoalReportspoint'),    
