...
onEachFeature: function(feature, layer) {
      ...
      html = ('<div class="row" style="padding:5px; margin-top:25px;"> ')
       ...
       html += ('<tr> <th><b> Description </b></th> <td>' + feature.properties['description'] + '</td><td rowspan="3"><a class="fancybox fancybox1" rel="ligthbox" href="/media/'+feature.properties['image']+'" title="' + feature.properties['project_community'] + '"><img src="/media/'+feature.properties['image']+'" alt="" style="width:100px; height:100px;" /></a></p> </td></tr>')

       }
       else{

         html += ('<tr> <th><b> Description </b></th> <td>' + feature.properties['description'] + '</td><td rowspan="3"><a class="fancybox fancybox1" rel="ligthbox" href="/media/img/no-image.png" title="' + feature.properties['project_community'] + '"><img src="/media/img/no-image.png" alt="" style="width:100px; height:100px;" /></a></p> </td></tr>')

       }

        html += ('<tr> <th>Status</th> <td>'+feature.properties['status']+'</td></tr>')

        if (feature.properties['voice']){

          

        html += ('<tr> <th>Voice Message  </th> <td><audio controls><source src="/media/'+ feature.properties['voice'] +'" type="audio/mp3">      </audio> </td></tr>')
...
function getextent(projectvalue){
    $.get('/galamsey/extenta/?valuecode=' + projectvalue ,function(data){
